...
htmlhelp_basename: str = 'gen_coap_servicedoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_coap_service.tex', 'gen_coap_service Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_coap_service', 'gen_coap_service Documentation',
    [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_coap_service', 'gen_coap_service Documentation', author,
    'gen_coap_service', 'One line description of project.', 'Miscellaneous'
)]
