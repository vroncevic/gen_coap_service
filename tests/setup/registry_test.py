...
Module
    registry_test.py
Info
    Unit tests for GenCoAPServiceBundleRegistry class.
'''
...
class TestGenCoAPServiceBundleRegistry(unittest.TestCase):
    ...
    def test_create_bundle_success(self) -> None:
        ...
        bundle = GenCoAPServiceBundleRegistry.create_bundle(dependencies)
    ...
    def test_get_version(self) -> None:
        self.assertEqual(GenCoAPServiceBundleRegistry.get_version(), '1.1.6')
