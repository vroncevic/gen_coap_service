...
Module
    test_engine.py
Info
    Unit tests for GenCoAPService engine.
'''
...
from gen_coap_service.engine import GenCoAPService
...
class TestGenCoAPService(unittest.TestCase):
    ...
    def test_engine_process_success(self) -> None:
        ...
        mock_base = BaseBundleFactory.create_bundle(
            options=BaseBundleOptions(
                info_file='gen_coap_service/infrastructure/config/gen_coap_service.cfg',
                use_generator=True,
    ...
    @patch('gen_coap_service.setup.validator.GenCoAPServiceBundleValidator.validate')
