...
'''
Module
    gen_coap_service_command_test.py
Info
    Unit tests for GenCoAPServiceCommandDefinition and GenCoAPServiceCommandExecutor.
'''
...
class TestGenCoAPServiceCommand(unittest.TestCase):

    def test_definition(self) -> None:
        definition = GenCoAPServiceCommandDefinition()
        self.assertEqual(definition.name, 'create')
        self.assertEqual(definition.help_text, 'Generate CoAP project files')
