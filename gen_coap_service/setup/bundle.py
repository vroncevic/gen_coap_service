...
Info
    Defines the gen_coap_service bundle.
'''
...
class GenCoAPServiceBundle:
    '''
        GenCoAPService bundle holding the components of the gen_coap_service.

        It defines:

            :attributes:
                | base - The base bundle with the base components.
                | service - The service orchestrating the gen_coap_service's execution.
                | subprocessor - The adapter executing the gen_coap_service's sub-processes.
                | cli - The command-line interface adapter.
            :methods:
                | to_dict - Converts the gen_coap_service bundle to a dictionary.
    '''
    ...
    def to_dict(self) -> dict[str, object]:
        '''
            Converts the gen_coap_service bundle to a dictionary.

            :return: Dictionary representation of the gen_coap_service bundle.
            :exceptions: None.
        '''
