...
Info
    GenCoAPService bundle options for the gen_coap_service bundle.
'''
...
class GenCoAPServiceBundleOptions(TypedDict):
    '''
        GenCoAPService bundle options for the gen_coap_service bundle.
        ...
        It defines:
            ...
            :attributes:
                | info_file - The info file path for the gen_coap_service bundle.
    '''
