...
Info
    A validator for the gen_coap_service bundle.
'''
...
class GenCoAPServiceBundleValidator:
    '''
        A validator for the gen_coap_service bundle.
    ...
    @classmethod
    def validate(cls, bundle: GenCoAPServiceBundle) -> None:
        '''
            Validates the gen_coap_service bundle.

            :param bundle: The gen_coap_service bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_coap_service_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_coap_service bundle must be provided'
        msg_bundle_istype: str = 'the gen_coap_service bundle must be an instance of GenCoAPServiceBundle'
        ...
        istype(bundle, GenCoAPServiceBundle, ctx, msg_bundle_istype)
