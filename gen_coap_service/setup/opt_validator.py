...
Info
    Validator for the gen_coap_service bundle options.
'''
...
class GenCoAPServiceBundleOptionsValidator:
    '''
        Validator for the gen_coap_service bundle options.
    ...
    @classmethod
    def validate(cls, options: GenCoAPServiceBundleOptions) -> None:
        '''
            Validates the gen_coap_service bundle options.

            :param options: The gen_coap_service bundle options to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_coap_service_bundle_options_validator::validate(...)'
        msg_options_none: str = 'the gen_coap_service bundle options must be provided'
        msg_options_istype: str = 'the gen_coap_service bundle options must be a Mapping'

        not_none(options, ctx, msg_options_none)
        istype(options, Mapping, ctx, msg_options_istype)

        for attr_name, expected_type in GenCoAPServiceBundleKeys.get_option_to_type().items():
