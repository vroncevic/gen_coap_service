...
Info
    Defines GenCoAPServiceCommandDefinition class.
'''
...
class GenCoAPServiceCommandDefinition:
    '''
        CLI subcommand metadata definition for coap_service project generation.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate CoAP project files'
    ...
    def options(self) -> Sequence[OptionData]:
        ...
        return [
            ...
            OptionData(
                name="--type",
                help_text="CoAP project type (coapthon/libcoap/node_coap)",
                action=None,
                default="coapthon",
                required=True,
                choices=["coapthon", "libcoap", "node_coap"],
                nargs=None
            ),
            OptionData(
                name="--output",
