...
from gen_coap_service.infrastructure.cli.setup.options import CLIBundleOptions
from gen_coap_service.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_coap_service.infrastructure.cli.setup.bundle import CLIBundle
from gen_coap_service.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_coap_service.infrastructure.command.icommand_definition import ICommandDefinition
from gen_coap_service.infrastructure.command.icommand_executor import ICommandExecutor
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenCoAPServiceCommandDefinition()
        service_executor: ICommandExecutor = GenCoAPServiceCommandExecutor(definition=service_definition)
