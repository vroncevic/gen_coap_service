...
| `gen_coap_service/core/service/engine.py` | 27 | 3 | 89%|
...
| `gen_coap_service/infrastructure/__init__.py` | 8 | 0 | 100%|
| `gen_coap_service/infrastructure/cli/__init__.py` | 9 | 0 | 100%|
| `gen_coap_service/infrastructure/cli/engine.py` | 39 | 7 | 82%|
| `gen_coap_service/infrastructure/cli/icli.py` | 16 | 2 | 88%|
| `gen_coap_service/infrastructure/cli/setup/__init__.py` | 9 | 0 | 100%|
| `gen_coap_service/infrastructure/cli/setup/bundle.py` | 22 | 1 | 95%|
| `gen_coap_service/infrastructure/cli/setup/dep_validator.py` | 28 | 0 | 100%|
| `gen_coap_service/infrastructure/cli/setup/dependencies.py` | 18 | 0 | 100%|
| `gen_coap_service/infrastructure/cli/setup/factory.py` | 32 | 32 | 0%|
| `gen_coap_service/infrastructure/cli/setup/keys.py` | 26 | 1 | 96%|
| `gen_coap_service/infrastructure/cli/setup/opt_validator.py` | 28 | 28 | 0%|
| `gen_coap_service/infrastructure/cli/setup/options.py` | 15 | 15 | 0%|
| `gen_coap_service/infrastructure/cli/setup/registry.py` | 21 | 0 | 100%|
| `gen_coap_service/infrastructure/cli/setup/validator.py` | 35 | 0 | 100%|
| `gen_coap_service/infrastructure/command/__init__.py` | 9 | 0 | 100%|
| `gen_coap_service/infrastructure/command/command.py` | 16 | 0 | 100%|
| `gen_coap_service/infrastructure/command/gen_coap_service_command_definition.py` | 24 | 1 | 96%|
| `gen_coap_service/infrastructure/command/gen_coap_service_command_executor.py` | 21 | 2 | 90%|
| `gen_coap_service/infrastructure/command/icommand_definition.py` | 15 | 0 | 100%|
| `gen_coap_service/infrastructure/command/icommand_executor.py` | 14 | 1 | 93%|
| `gen_coap_service/infrastructure/subprocessor.py` | 55 | 19 | 65%|
| `gen_coap_service/setup/__init__.py` | 9 | 0 | 100%|
| `gen_coap_service/setup/bundle.py` | 23 | 1 | 96%|
| `gen_coap_service/setup/dep_validator.py` | 28 | 0 | 100%|
| `gen_coap_service/setup/dependencies.py` | 19 | 0 | 100%|
| `gen_coap_service/setup/factory.py` | 45 | 1 | 98%|
| `gen_coap_service/setup/keys.py` | 27 | 1 | 96%|
| `gen_coap_service/setup/opt_validator.py` | 26 | 9 | 65%|
| `gen_coap_service/setup/options.py` | 12 | 0 | 100%|
| `gen_coap_service/setup/registry.py` | 29 | 0 | 100%|
| `gen_coap_service/setup/validator.py` | 40 | 0 | 100%|
| **Total** | 879 | 124 | 86% |
