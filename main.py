...
def main() -> bool:
    '''
        Bootstraps and runs the gen_coap_service with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None
    '''
    gen_coap_service: GenCoAPService = GenCoAPService(GenCoAPServiceBundleFactory.create_bundle())

    return gen_coap_service.process()


if __name__ == '__main__':
    '''
        Entry point for gen_coap_service execution.
